...
public:
	...
	void UpdateStatusBar(int TimeStep, double CastleHealth, CASTLE_STATUS FROZ, int ActiveFightersCount, int ActiveHealersCount, int Num_ActiveFreezers, int ActiveCount,
	...
	void UpdateInterface(int TimeStep, double CastleHealth, CASTLE_STATUS FROZ, int ActiveFightersCount, int ActiveHealersCount, int Num_ActiveFreezers, int ActiveCount,
		int FrostedFightersCount, int FrostedHealersCount, int FrostedFreezersCount, int FrostedCount,
		int KilledFightersCount, int KilledFreezersCount, int KilledHealersCount, int KilledCount);
